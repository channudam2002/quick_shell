<template>
    <div class="flex flex-row items-center justify-center w-screen h-screen">
        ...
        <div class=" w-1/2 flex flex-row items-center justify-center">
            <router-link :to="{name: 'home'}" class="absolute top-14 right-14 text-general flex flex-row items-center hover:drop-shadow-md">
                ...
                <div class="w-full">
                    <form class="space-y-6 w-full" @submit.prevent="signup">
                        ...
                        <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                            Already registered? <router-link :to="{name: 'sign-in'}" class="text-blue-700 hover:underline dark:text-blue-500">Sign in</router-link>
                        </div>
                    </form>
                </div>
            </div>
